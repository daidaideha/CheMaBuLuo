 ...
 */
public class ShopAdatper extends BaseAdapter {
    private Context context;
    private LayoutInflater inflater;
    private List<ShopUnit> listData;

    public ShopAdatper(Activity context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        convertView = inflater.inflate(R.layout.adapter_shop, null);
        View iv_line = convertView.findViewById(R.id.iv_line);
        if (position == 0)
