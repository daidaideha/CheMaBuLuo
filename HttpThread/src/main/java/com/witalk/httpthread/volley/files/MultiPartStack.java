package com.witalk.httpthread.volley.files;
...
import com.witalk.httpthread.volley.toolbox.HttpClientStack.HttpPatch;
import com.witalk.httpthread.volley.toolbox.HurlStack;
...
public class MultiPartStack extends HurlStack {
	...
	private static void setMultiPartBody(HttpEntityEnclosingRequestBase httpRequest,
		...
		for (Map.Entry<String, File[]> entry : fileUpload.entrySet()) {
			for (File file : fileUpload.get((String) entry.getKey())) {
